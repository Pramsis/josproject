...
<div class="container">
  <div class="ro">
    <div class="col-md-12">
      <h1 class="text-center text-home"><hr>Jurnal Kelas XI RPL 1</hr></h1>
    </div>
  </div>
</div>
@endsection
...
<form action="{{ route('jurnal.xrpl1') }}" method="post">
  ...
  <input type="hidden" name="kelas" class="form-control update" value="XI RPL 1">
